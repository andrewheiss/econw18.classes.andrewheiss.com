...
The consumer price index (1982–84 = 100) in December 1980 was `r filter(cpi, DATE == "1980-12-01") %>% pull(CPIAUCSL)`, and it was `r filter(cpi, DATE == "2017-12-01") %>% pull(CPIAUCSL)` in December 2017.^[Source: [`CPIAUCSL` from FRED](https://fred.stlouisfed.org/series/CPIAUCSL)] How much inflation has there been between 1980 and 2017?
