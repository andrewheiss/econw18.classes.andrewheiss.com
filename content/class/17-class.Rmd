...
[Download the slides from today's lecture](/slides/MPA-612_2018-03-12.pdf).

<figure>
[![First slide](/images/slides/slides_2018-03-12.png)](/slides/MPA-612_2018-03-12.pdf)
</figure>
...
results <- read_csv(file.path(here(), "static", "data", "multiplicative-airlines.csv"),
...
Go to [this form](https://goo.gl/forms/okg0bpPQJQCmyFZA2) and answer these three questions (anonymously if you want):
...
```{r figures-for-slides, include=FALSE}
source(file.path(here(), "lib", "graphics.R"))
